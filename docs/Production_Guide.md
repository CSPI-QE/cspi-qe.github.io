...
# (WIP) OpenShift CI Production Guide<!-- omit from toc -->
...
## Overview
This is meant to be a sort of final check just to make sure that you covered all parts of the scenario onboarding.
